...
import { ColumnMap, ColumnType, getInitialData, Person } from "@/bin/data/people";
...
import Board from "@/components/NewComps/Board";
import Column from "@/components/NewComps/Column";

const Teste = () => {
    const [data, setData] = useState<{
        columnMap: ColumnMap;
        orderedColumnIds: string[];
    }>(() => getInitialData({ itemsPerColumn: 8 }));
